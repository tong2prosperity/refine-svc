#!/usr/bin/env python3
"""
Test client for svc_backend WebSocket API with ONNX and pitch shift support.
"""
...
async def convert_audio(
    audio_path: str,
    output_path: str,
    backend_url: str = "ws://localhost:8105",
    ...
    **config_overrides,
    ...
    async with websockets.connect(ws_url) as websocket:
        ...
        for idx, start in enumerate(range(0, pcm_int16.size, chunk_size)):
            ...
            # await asyncio.sleep(chunk.size / source_sample_rate)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="WebSocket backend URL (default: ws://localhost:8105)",
    )
    parser.add_argument(
        "--voice-id",
        type=str,
    ...
    if args.pitch_shift != 0.0:
        config_overrides["pitch_shift"] = args.pitch_shift
